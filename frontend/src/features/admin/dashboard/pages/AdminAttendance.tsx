...
export const AdminAttendance = () => {
    ...
    const fetchData = async () => {
        try {
            setLoading(true);
            // Fetch all sessions (Admin sees everything)
                        ...
                        <div className="flex items-center gap-4 flex-wrap">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-[var(--text-secondary)]">
                                    Present: <strong className="text-[var(--text-primary)]">{totalPresent}</strong>
                                </span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-3 h-3 bg-[var(--danger)]"></span>
                                <span className="text-sm text-[var(--text-secondary)]">
                                    Absent: <strong className="text-[var(--text-primary)]">{totalAbsent}</strong>
                                </span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="w-3 h-3 bg-[var(--warning)]"></span>
                                <span className="text-sm text-[var(--text-secondary)]">
                                    Late: <strong className="text-[var(--text-primary)]">{totalLate}</strong>
                                </span>
                            </div>
                        </div>
                    </div>
